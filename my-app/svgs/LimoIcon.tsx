...
export default function LimoIcon({ width = 800, height = 800, ...props }: LimoIconProps) {
  return (
    <svg
      {...props}
      width={width}
      ...
      style={{
        enableBackground: "new 0 0 122.88 36.6",
        transform: "scaleX(-1)", // Flip the icon horizontally
      }}
      xmlSpace="preserve"
    >
      {/* Define the CSS styles for the SVG */}
      <style type="text/css">
        {`.st0 {
          fill-rule: evenodd;
          clip-rule: evenodd;
      ...
      <g>
        {/* Main path defining the limo shape */}
        <path
          className="st0"
