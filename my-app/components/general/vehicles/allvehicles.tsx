...
// Define the car interface for better type checking
interface Car {
  id: number;
  make: string;
  model: string;
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-12">
            ...
            <div className="flex justify-center items-center mb-4">
              <Button className="w-full md:w-auto mr-2" onClick={handleSearch}>
            ...
            {searchResults.map((car) => (
              <Card key={car.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent className="p-4">
                  ...
                  <Link href={`/carinfo/${car.id}`} passHref>
