...
// Separate ReviewCard component for better organization
const ReviewCard: React.FC<{ review: typeof recentReviews[0] }> = ({ review }) => (
  <Card className="bg-white/50 backdrop-blur-sm hover:bg-white/60 transition-colors duration-200">
